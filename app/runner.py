"""Подготовка и запуск генератора как подпроцесса.

Этот модуль собирает CLI-команду, задаёт окружение UTF-8 и даёт единое место,
через которое GUI и консольный раннер запускают `scripts/generate_pattern.py`.
"""
