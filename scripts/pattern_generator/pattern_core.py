...
# Отдельный резервный набор символов для блендов.
# Он не пересекается с основным алфавитом схемы, чтобы бленды всегда получали
# стабильные и читаемые обозначения без конфликтов с обычными цветами.
BLEND_SYMBOLS = [
    "B", "C", "D", "E", "F", "G", "J", "L", "P", "Q",
    "R", "U", "W", "2", "3", "4", "5", "6", "7", "8",
]
