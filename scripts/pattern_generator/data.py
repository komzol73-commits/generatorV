"""Данные генератора: палитры, символы и справочники.

Здесь лежат большие константы проекта: палитра DMC, символы схемы и карта
DMC→Gamma. Модуль нужен как единый источник данных для остальных частей.
"""
