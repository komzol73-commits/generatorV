...
# сначала идут самые заметные залитые формы, затем контурные фигуры,
# после них — плотные знаки и только потом простые линии. Буквы и цифры
# исключены из основного алфавита схемы, потому что на мелкой сетке они
# читаются хуже и чаще слипаются между собой.
# =============================================================================
SYMBOLS = [
    "■", "●", "▲", "◆", "○", "□", "△", "◇", "▼", "◀",
    "A", "H", "K", "M", "N", "T", "V", "X", "Y", "R",
